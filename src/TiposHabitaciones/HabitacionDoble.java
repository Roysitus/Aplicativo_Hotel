...
Esto dice vicente
*/
public class HabitacionDoble extends Habitacion implements Informacion_de_habitaciones{
    ...
    public HabitacionDoble(double precio, String descipcion, String tipo, int nro_adultos, int nro_ninos) {
